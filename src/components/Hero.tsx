  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <motion.div
        ...
        className="absolute top-1/4 left-[15%] text-primary/30 hidden lg:block"
      >
        <Code2 size={48} />
      </motion.div>
      <motion.div
        ...
        className="absolute bottom-1/3 right-[15%] text-primary/30 hidden lg:block"
      >
        <Database size={40} />
      </motion.div>
      <motion.div
        ...
        className="absolute top-1/3 right-[20%] text-primary/20 hidden lg:block"
      >
        <Sparkles size={32} />
      </motion.div>
